...
namespace AdventOfCode2023Tests
{
    ...
    {
        [Test]
        public void OneLinePossibleTest()
        {
            var input = "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green";

            var actual = Day2Part1.Day2Part1Main(input);
            var expected = 1;
        ...
        [Test]
        public void OneLineNotPossibleTest()
        {
        ...
        {
            #region input
            var input = @"Game 1: 7 blue, 9 red, 1 green; 8 green; 10 green, 5 blue, 3 red; 11 blue, 5 red, 1 green
